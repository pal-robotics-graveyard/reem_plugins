...
GZ_REGISTER_DYNAMIC_CONTROLLER("reem_diffdrive_plugin", reemDiffdrivePlugin);
...
// Destructor
reemDiffdrivePlugin::~reemDiffdrivePlugin()
{
...
// Load the controller
void reemDiffdrivePlugin::LoadChild(XMLConfigNode *node)
{
  ...
  int argc = 0;
  char** argv = NULL;
  ros::init(argc, argv, "reem_diffdrive_plugin", ros::init_options::NoSigintHandler | ros::init_options::AnonymousName);
...
void reemDiffdrivePlugin::InitChild()
{
  ...
  callback_queue_thread_ = new boost::thread(boost::bind(&reemDiffdrivePlugin::QueueThread, this));
}

// Load the controller
void reemDiffdrivePlugin::SaveChild(std::string &prefix, std::ostream &stream)
{
...
// Reset
void reemDiffdrivePlugin::ResetChild()
{
  // Reset odometric pose
  odomPose[0] = 0.0;
  odomPose[1] = 0.0;
...
void reemDiffdrivePlugin::UpdateChild()
{
...
void reemDiffdrivePlugin::FiniChild()
{
...
void reemDiffdrivePlugin::GetPositionCmd()
{
  lock.lock();
...
void reemDiffdrivePlugin::cmdVelCallback(const geometry_msgs::Twist::ConstPtr& cmd_msg)
{
...
void reemDiffdrivePlugin::QueueThread()
{
...
void reemDiffdrivePlugin::publish_odometry()
{
  // get current time
...
void reemDiffdrivePlugin::write_position_data()
{
  // TODO: Data timestamp
